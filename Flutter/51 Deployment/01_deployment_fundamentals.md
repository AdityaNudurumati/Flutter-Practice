...
Release builds ship AOT-compiled Dart + the engine; App Bundle strips unneeded ABIs/resources per device ([04_app_size_and_build_optimization.md](04_app_size_and_build_optimization.md)).
