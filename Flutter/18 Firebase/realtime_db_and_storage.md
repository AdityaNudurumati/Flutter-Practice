...
RTDB snapshots hold tree data in memory; Storage streams bytes (don't load huge files fully — stream). Store only **URLs** (not blobs) in the DB ([15 · file_storage](../15%20Local%20Storage/file_storage.md)).
...
- Consider CDN/caching for served files; downscale images before upload ([07 · images](../07%20Widgets/images_and_assets.md)).
