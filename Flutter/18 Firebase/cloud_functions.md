...
Functions run server-side (not in the app); the Flutter side only sends/receives JSON. Callable results map to domain models in a repository ([05 · repository](../05%20Design%20Patterns/repository.md)).
