...
- **Isolates**: background isolates need their **own** error handling (`Isolate.addErrorListener` / handle in the entry) — the main zone doesn't catch them ([02 · isolates](../02%20Advanced%20Dart/04_isolates.md)).
