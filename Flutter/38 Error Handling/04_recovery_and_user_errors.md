...
This file is the UX + resilience end of error handling: turning caught failures ([01_errors_vs_exceptions.md](01_errors_vs_exceptions.md), [02_result_and_either.md](02_result_and_either.md)) into recovery (retry/degrade) and clear messages. It covers retry/backoff, graceful degradation, error→message mapping, and error-state UI patterns.
...
Recovery/UX is where the error strategy pays off for users: typed failures ([02_result_and_either.md](02_result_and_either.md)) become retry/degradation decisions and clear messages, driven by explicit UI states, while the underlying failures still flow to monitoring. Centralizing retry policy, degradation, and error→message mapping (behind services/state) makes resilience consistent and testable — the user-facing complement to global capture ([03_global_error_handling.md](03_global_error_handling.md), [Module 19](../19%20Offline%20First/README.md), [Module 52](../52%20Monitoring/README.md)).
