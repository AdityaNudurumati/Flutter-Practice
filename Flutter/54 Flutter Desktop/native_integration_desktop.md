...
- **System integration** (via plugins/channels): system tray, notifications, clipboard, global shortcuts, single-instance, launch-at-startup, deep links — many via community desktop plugins (check support; FFI/channel for gaps — [desktop_fundamentals.md](desktop_fundamentals.md)).
