...
Enterprise architecture is the handbook's architecture band composed at full strength and governed for many teams over years: a modular monorepo of feature packages (Clean inside, DDD in the core, MVVM presentation) over a stable shared core, with cross-feature contracts, aligned to team topology (Conway's Law). It's **composition + governance + right-sizing**, not invention — the structural foundation on which enterprise cross-cutting concerns and integrations are built ([03_cross_cutting_enterprise_concerns.md](03_cross_cutting_enterprise_concerns.md), [04_integration_and_case_studies.md](04_integration_and_case_studies.md), [Module 47](../47%20Scalable%20Applications/README.md)).
