...
Backed by `RenderFlex` render objects ([06](../06%20Flutter%20Fundamentals/04_widgets_elements_render_objects.md)); layout computed via constraints ([03_constraints_and_sizing.md](03_constraints_and_sizing.md)).
...
7. **🔴 Why does a `Row` inside a `Row` sometimes throw an unbounded-width error?** — The inner needs a bounded width; wrap it in `Expanded`/`Flexible` or constrain it ([03_constraints_and_sizing.md](03_constraints_and_sizing.md)).
...
- Extract repeated `Row`/`Column` structures into small widgets ([09_custom_composite_widgets.md](09_custom_composite_widgets.md)).
