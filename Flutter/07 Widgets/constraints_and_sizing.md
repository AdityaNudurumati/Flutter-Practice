...
| `Expanded`/`Flexible` | Fill within a Flex ([layout_flex.md](layout_flex.md)) |
...
Constraints/sizes are computed per frame in the render tree; no persistent extra allocation beyond render objects ([06](../06%20Flutter%20Fundamentals/widgets_elements_render_objects.md)).
