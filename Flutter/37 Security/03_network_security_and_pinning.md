...
Pins (cert/SPKI hashes) are small constants/config. Tokens live in secure storage ([02_secure_storage_and_encryption.md](02_secure_storage_and_encryption.md)). No secrets in the binary.
