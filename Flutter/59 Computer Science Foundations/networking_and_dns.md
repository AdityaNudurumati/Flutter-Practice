...
- [HTTP fundamentals](../16%20Networking/http_fundamentals.md)
- [HTTP and TLS](./http_and_tls.md)
- [Connectivity (device features)](../29%20Device%20Features/connectivity.md)
...
- **Use TLS (`https`)** for everything; treat plaintext as a debugging-only exception. See [HTTP and TLS](./http_and_tls.md).
...
See also: [Networking overview](../16%20Networking/README.md) · [HTTP fundamentals](../16%20Networking/http_fundamentals.md) · [HTTP and TLS](./http_and_tls.md) · [Connectivity](../29%20Device%20Features/connectivity.md)
