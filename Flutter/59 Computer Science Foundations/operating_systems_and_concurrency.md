...
See also: [Dart isolates](../02%20Advanced%20Dart/isolates.md), [Dart event loop](../02%20Advanced%20Dart/event_loop.md), [Async & futures](../02%20Advanced%20Dart/async_futures.md).
...
- **Event loop per isolate.** The VM drives each isolate's microtask and event queues (see [event loop](../02%20Advanced%20Dart/event_loop.md)).
...
Cross-links: [isolates](../02%20Advanced%20Dart/isolates.md), [event loop](../02%20Advanced%20Dart/event_loop.md), [async & futures](../02%20Advanced%20Dart/async_futures.md), [threading model](../10%20Flutter%20Architecture/threading_model.md), [background services](../33%20Background%20Services/README.md).
