...
Related reading:
- [JSON & Serialization in Dart](../02%20Advanced%20Dart/12_json_and_serialization.md)
- [gRPC](../16%20Networking/05_grpc.md)
- [REST client & interceptors](../16%20Networking/02_rest_client_and_interceptors.md)
- [Isolates](../02%20Advanced%20Dart/04_isolates.md)
...
See [Isolates](../02%20Advanced%20Dart/04_isolates.md) for the full model.
...
This is exactly what makes gRPC services deployable without lock-step client/server upgrades. See [gRPC](../16%20Networking/05_grpc.md).
...
- Add a `Content-Encoding`-style negotiation stub simulating client/server capability exchange (see [REST client & interceptors](../16%20Networking/02_rest_client_and_interceptors.md)).
