...
- [HTTP fundamentals (Networking)](../16%20Networking/01_http_fundamentals.md)
- [REST client and interceptors](../16%20Networking/02_rest_client_and_interceptors.md)
- [Network security and pinning](../37%20Security/03_network_security_and_pinning.md)
- [Networking and DNS foundations](./03_networking_and_dns.md)
- [Security foundations](./07_security_foundations.md)
...
1. **DNS resolution** — hostname → IP (see [networking and DNS](./03_networking_and_dns.md)). Cached by OS.
...
- Centralize networking in one layer with **interceptors** for auth, retries, and logging (see [REST client and interceptors](../16%20Networking/02_rest_client_and_interceptors.md)).
...
- **Observability**: standardize on an interceptor layer for tracing, metrics (TTFB, handshake time), and correlation IDs. See [REST client and interceptors](../16%20Networking/02_rest_client_and_interceptors.md).
...
Stretch: add HTTP/3 support detection and fall back cleanly; add a remote "kill switch" that can disable pinning in an emergency rotation. See [network security and pinning](../37%20Security/03_network_security_and_pinning.md) and [security foundations](./07_security_foundations.md).
