...
The engine composites the native view into its surface (hybrid composition) — extra work vs pure Flutter layers ([09 · compositing](../09%20Rendering%20Pipeline/05_compositing_and_repaint_boundaries.md)).
...
- Profile compositing/raster when adding them ([21 · jank_and_raster](../21%20Performance/03_jank_and_raster.md)).

## Performance

Platform views add native-view compositing overhead vs Flutter layers — heavier, can jank if many/large or in lists. Use sparingly; profile ([21 · jank_and_raster](../21%20Performance/03_jank_and_raster.md)).
