...
- **Three pillars, correlated** ([monitoring_fundamentals.md](monitoring_fundamentals.md)):
  - **Stability** — crash reporting (crash-free rate, symbolicated stacks, breadcrumbs — [crash_reporting.md](crash_reporting.md)).
  - **Usage** — analytics (event taxonomy, funnels, retention, privacy-safe — [analytics_and_metrics.md](analytics_and_metrics.md)).
  - **Performance** — field SLIs/SLOs (startup/frames/network/custom traces — [performance_monitoring_and_alerting.md](performance_monitoring_and_alerting.md)).
