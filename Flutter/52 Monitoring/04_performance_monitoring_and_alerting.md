...
- **Dashboards**: visualize SLIs over time, **per version** (release health), device tier, network — to spot **trends + regressions** (a new version's p95 startup climbing) alongside crash-free rate ([02_crash_reporting.md](02_crash_reporting.md)).
