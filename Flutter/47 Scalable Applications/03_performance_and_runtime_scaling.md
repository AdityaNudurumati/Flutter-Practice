...
- **Right-sizing**: a small app rarely needs budgets/deferred loading; a large one needs all of it. Introduce as the runtime dimension shows pressure ([01_scaling_dimensions.md](01_scaling_dimensions.md)).
