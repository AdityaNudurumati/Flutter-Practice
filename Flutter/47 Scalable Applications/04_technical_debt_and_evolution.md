...
- **Prevent new debt**: governance (lints, review, architecture guide), tests, and design-system/contracts reduce the rate debt accrues ([02_codebase_and_team_scaling.md](02_codebase_and_team_scaling.md)).
