...
- **Right-sizing**: solo/small → light conventions + feature-first folders; growing/multi-team → modular packages + CODEOWNERS + strict governance + a design system. Introduce as the team/codebase pressure appears ([scaling_dimensions.md](scaling_dimensions.md)).
...
- **Right-size** governance/ownership to team size; grow structure as codebase/team pressure appears ([scaling_dimensions.md](scaling_dimensions.md)).
