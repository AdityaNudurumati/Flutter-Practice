...
- **The winning shape**: clarify → scope → plan increments → build core (right-sized) → handle edge cases → polish → (light test if time) → communicate throughout ([02_approach_and_time_management.md](02_approach_and_time_management.md)).
