...
- **Custom icons**: `BitmapDescriptor` from asset/bytes ([04_live_location_and_clustering.md](04_live_location_and_clustering.md)).

## Memory Representation

Overlay sets are lightweight Dart value objects; the native map holds the rendered geometry. Thousands of markers get expensive → cluster ([04_live_location_and_clustering.md](04_live_location_and_clustering.md)).
...
| Thousands of raw markers | Jank/memory | Cluster ([04_live_location_and_clustering.md](04_live_location_and_clustering.md)) |
...
- **Cluster** large marker counts; use `BitmapDescriptor` for custom pins ([04_live_location_and_clustering.md](04_live_location_and_clustering.md)).
