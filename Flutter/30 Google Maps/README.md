...
This module covers embedding and driving **Google Maps** in Flutter with `google_maps_flutter`: **setup** (API keys per platform, the `GoogleMap` widget, `GoogleMapController`), **overlays** (markers, polylines, polygons, circles, info windows), **camera control** (move/animate, bounds, gestures), and advanced patterns — **custom markers, live location on the map, and clustering** for large datasets. It builds on device location ([Module 29](../29%20Device%20Features/02_geolocation.md)) and platform views ([Module 27](../27%20Native%20Android/03_platform_views_android.md)/[28](../28%20Native%20iOS/03_platform_views_ios.md)).
...
| # | File | Topic | Level |
|---|------|-------|-------|
| 1 | [01_maps_setup_and_widget.md](01_maps_setup_and_widget.md) | API keys, `GoogleMap` widget, `GoogleMapController`, camera position | 🔵 |
| 2 | [02_markers_and_overlays.md](02_markers_and_overlays.md) | Markers, polylines, polygons, circles, info windows | 🔵 |
| 3 | [03_camera_control.md](03_camera_control.md) | Move/animate camera, bounds, zoom, gestures, map styling | 🟡 |
| 4 | [04_live_location_and_clustering.md](04_live_location_and_clustering.md) | Custom markers, live location, marker clustering at scale | 🔴 |
| 5 | [05_maps_integration.md](05_maps_integration.md) | Capstone: map behind a controller/repository, live tracking | 🔴 |

> **Cross-references:** Location source: [29 · geolocation](../29%20Device%20Features/02_geolocation.md). Platform views (how the map embeds): [27](../27%20Native%20Android/03_platform_views_android.md)/[28](../28%20Native%20iOS/03_platform_views_ios.md). Compositing cost: [09 · compositing](../09%20Rendering%20Pipeline/05_compositing_and_repaint_boundaries.md). Performance: [Module 21](../21%20Performance/README.md). State management: [Module 11](../11%20State%20Management/README.md).
...
**Live map slice:** A map that shows the user's live location (from [Module 29](../29%20Device%20Features/02_geolocation.md)), plots many place markers with clustering, draws a route polyline, animates the camera to fit results/follow the user, and surfaces marker taps — with all map state driven through a controller/repository.
