...
- A subclass instance is one object containing **all** fields (inherited + own). The method table links to inherited and overridden implementations for dynamic dispatch ([04_polymorphism.md](04_polymorphism.md)).
...
| Mistake | Why | Fix |
|---------|-----|-----|
| Inheriting for code reuse without is-a | Fragile hierarchies, LSP violations | Use composition ([06_composition_and_relationships.md](06_composition_and_relationships.md)) |
