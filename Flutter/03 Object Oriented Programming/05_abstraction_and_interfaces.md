...
- Interfaces/abstracts dispatch polymorphically ([04_polymorphism.md](04_polymorphism.md)).
...
- Reach for `sealed` + patterns to replace enum-plus-nullable-fields state modeling ([02 · records_and_patterns](../01%20Dart%20Fundamentals/09_records_and_patterns.md)).
