...
- Instance methods dispatch on the runtime type (virtual dispatch — see [polymorphism.md](polymorphism.md)).
- The object is collectible once unreachable ([02 · memory_and_gc](../02%20Advanced%20Dart/memory_and_gc.md)).
...
| Mistake | Why | Fix |
|---------|-----|-----|
| Public mutable fields | Breaks encapsulation/invariants | Private field + getter (see [encapsulation.md](encapsulation.md)) |
...
- Object allocation is cheap but not free; avoid churning short-lived objects in hot paths ([02 · memory_and_gc](../02%20Advanced%20Dart/memory_and_gc.md)).
...
6. **🔴 When is an object eligible for GC?** — When it becomes unreachable from all roots ([02 · memory_and_gc](../02%20Advanced%20Dart/memory_and_gc.md)).
