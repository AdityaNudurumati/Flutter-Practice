...
- **Composition vs mixins:** mixins add behavior at *compile time* into the type; composition holds a *runtime* collaborator you can swap/inject. Prefer composition when the behavior has state/lifecycle or should be swappable ([02 · mixins](../02%20Advanced%20Dart/mixins.md)).
...
- Keep composed collaborators behind interfaces so they're mockable and replaceable ([abstraction_and_interfaces.md](abstraction_and_interfaces.md)).
