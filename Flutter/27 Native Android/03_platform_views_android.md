...
The engine composites the native view into its surface via the platform-view system (hybrid/virtual display/TLHC) — extra work vs pure Flutter layers ([09 · compositing](../09%20Rendering%20Pipeline/05_compositing_and_repaint_boundaries.md)).
...
Platform views add compositing/texture overhead vs Flutter layers — heavier and can jank if many/large or in lists. Use sparingly; profile raster/compositing ([21 · jank_and_raster](../21%20Performance/03_jank_and_raster.md)).
