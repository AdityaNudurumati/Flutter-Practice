...
Same route-stack behavior as imperative ([01_navigator_stack.md](01_navigator_stack.md)); the route table/factory is config on `MaterialApp`.
...
Negligible; `onGenerateRoute` runs per navigation (keep it light). Same stack cost as imperative ([01_navigator_stack.md](01_navigator_stack.md)).
