...
- **Shallow vs deep** clone matters when the object has mutable nested state ([03 · equality_and_copying](../03%20Object%20Oriented%20Programming/07_equality_and_copying.md)).
