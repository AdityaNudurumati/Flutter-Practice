...
The subject holds references to observers → **observers won't be GC'd while subscribed**; forgetting to unsubscribe leaks them ([02 · memory_and_gc](../02%20Advanced%20Dart/memory_and_gc.md)).
...
- Treat every subscription as owned; cancel in `dispose` (a top Flutter leak source — [02 · memory_and_gc](../02%20Advanced%20Dart/memory_and_gc.md)).
