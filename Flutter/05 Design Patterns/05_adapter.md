...
- Pair with the Repository pattern ([20_repository.md](20_repository.md)) — the repository interface is the target, the adapter/impl wraps the SDK/HTTP.
