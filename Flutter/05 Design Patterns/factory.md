...
- Dart's `factory` constructor ([02 · constructors](../02%20Advanced%20Dart/constructors_and_singletons.md)) natively supports the Simple Factory idiom.
...
- Combine factory + DI: register factories in the container so creation and wiring stay centralized ([dependency_injection.md](dependency_injection.md)).
