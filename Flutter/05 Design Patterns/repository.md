...
The repo may hold an in-memory cache; bound it to avoid leaks ([02 · memory_and_gc](../02%20Advanced%20Dart/memory_and_gc.md)).
...
- Map DTO↔entity and translate errors **inside** the repository ([02 · json](../02%20Advanced%20Dart/json_and_serialization.md), [Module 38](../38%20Error%20Handling/README.md)).
- Inject data sources; make the whole thing fakeable for tests.
- Put caching/offline strategy here, bounded.

## Performance

Centralized caching improves latency; bound caches; offload heavy parsing to isolates ([02 · isolates](../02%20Advanced%20Dart/isolates.md)).
