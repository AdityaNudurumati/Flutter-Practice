...
- Decoded JSON is a heap tree of maps/lists. Large payloads are large trees — parse them off the UI isolate (`compute`) to avoid jank ([isolates.md](isolates.md)).
