...
- No forced `UnsupportedError` stubs → fewer runtime surprises (also an LSP win — [03_lsp_liskov_substitution.md](03_lsp_liskov_substitution.md)).
...
- Let **clients own the interfaces** they depend on (define `ReadableUserSource` where the reader lives), then implementations adapt to them — this also enables DIP ([05_dip_dependency_inversion.md](05_dip_dependency_inversion.md)).
