...
- DIP is the mechanism that makes **OCP** and swap/mocking possible; it relies on polymorphism ([03](../03%20Object%20Oriented%20Programming/polymorphism.md)) and lean interfaces (ISP).
