...
This file covers writing fast, isolated unit tests: structure (AAA, groups, setup), test doubles (fakes/mocks/stubs) and when to use each, mocktail basics, and the TDD cycle. It's the base of the pyramid ([01_testing_fundamentals_and_pyramid.md](01_testing_fundamentals_and_pyramid.md)) — where most tests and confidence live.
