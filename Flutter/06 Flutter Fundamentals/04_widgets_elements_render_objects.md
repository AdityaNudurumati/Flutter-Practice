...
Widgets are short-lived (GC'd each rebuild); Elements and RenderObjects persist across frames and hold the real state/layout data ([02 · memory_and_gc](../02%20Advanced%20Dart/13_memory_and_gc.md)).
