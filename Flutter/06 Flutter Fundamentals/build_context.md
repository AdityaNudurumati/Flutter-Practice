...
The context is the Element itself (persistent in the Element tree); no extra allocation ([widgets_elements_render_objects.md](widgets_elements_render_objects.md)).
