...
Deep-link restoration builds the matched stack once; no special memory beyond the resulting routes ([12 · navigator_stack](../12%20Navigation/navigator_stack.md)).
...
The embedder delivers platform route info (deep links) to the framework ([10 · embedder_and_startup](../10%20Flutter%20Architecture/embedder_and_startup.md)).
