...
- **Centralize** adaptation in helpers/a design system ([04_cross_platform_design_system.md](04_cross_platform_design_system.md)); make platform overridable for testing/previews.
