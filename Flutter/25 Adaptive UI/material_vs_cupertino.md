...
- **Material** (`material.dart`): `MaterialApp`, `Scaffold`, `AppBar`, `ElevatedButton`, `Switch`, `TextField`, Material 3 theming (`ThemeData`, `colorScheme` — [07 · text_and_theming](../07%20Widgets/text_and_theming.md)). Default for Android/web.
...
- **Centralize** platform choices in a design-system layer ([cross_platform_design_system.md](cross_platform_design_system.md)); keep detection overridable.
