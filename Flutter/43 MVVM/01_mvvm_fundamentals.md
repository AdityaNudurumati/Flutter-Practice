...
- **Realizations**: `ChangeNotifier` + `ListenableBuilder`, **Provider**, **Riverpod**, **Bloc/Cubit**, GetX — all are ways to expose observable state a View binds to (i.e., MVVM) ([03_data_binding_and_state.md](03_data_binding_and_state.md)).
...
- Keep the ViewModel **plain Dart** (testable via state assertions); pick a realization (Provider/Riverpod/Bloc/`ChangeNotifier`) that fits ([03_data_binding_and_state.md](03_data_binding_and_state.md)).
