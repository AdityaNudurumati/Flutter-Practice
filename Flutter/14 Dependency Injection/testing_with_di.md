...
Test doubles are lightweight objects; reset DI (`getIt.reset()`, dispose containers) between tests to avoid state bleed ([08 · dispose_and_leaks](../08%20Widget%20Lifecycle/dispose_and_leaks.md)).
