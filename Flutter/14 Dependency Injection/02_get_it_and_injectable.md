...
Singletons/lazy-singletons persist for the app (or scope) lifetime; factories are transient. Registered disposables should be disposed on scope pop/reset (`dispose` param) ([08 · dispose_and_leaks](../08%20Widget%20Lifecycle/05_dispose_and_leaks.md)).
...
Lazy singletons defer creation; factories allocate per call. Registry lookups are O(1)-ish. No notable runtime cost ([04_scopes_and_lifetimes.md](04_scopes_and_lifetimes.md)).
