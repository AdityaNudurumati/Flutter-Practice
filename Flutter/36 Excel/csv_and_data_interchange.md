...
- **Typeless**: every field is a **string** — you must **coerce** (parse int/double/date) and **validate** per column on import ([import_export_large_datasets.md](import_export_large_datasets.md)); numbers/dates have no format, and locale affects decimal separators.
...
- Treat fields as **strings** → **coerce + validate types per column** on import ([import_export_large_datasets.md](import_export_large_datasets.md)); mind **locale decimal separators**.
