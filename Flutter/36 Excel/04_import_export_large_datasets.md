...
- **Row-level resilience**: skip/flag blank rows, tolerate extra/missing columns, handle date **serials** (XLSX) and **locale decimals** (CSV) ([02_cells_styles_and_formulas.md](02_cells_styles_and_formulas.md), [03_csv_and_data_interchange.md](03_csv_and_data_interchange.md)).
- **Large files — memory**:
