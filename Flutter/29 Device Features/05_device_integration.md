...
- **Centralized permissions**: a `PermissionService` ([27](../27%20Native%20Android/04_permissions_and_manifest.md)/[28](../28%20Native%20iOS/04_infoplist_and_permissions.md)) all repositories use; request in context, handle denied/restricted → Settings.
