...
- Client: initiate + **poll/subscribe for confirmed state** (pending → confirmed/failed/refunded); never grant/set amount/trust its callback ([payments_overview_and_security.md](payments_overview_and_security.md)).
