...
- **Wallets**: both route Apple Pay / Google Pay for physical purchases through the same sheet ([wallets_google_apple_pay.md](wallets_google_apple_pay.md)).
...
- Wrap in a **repository** returning a domain `PaymentResult`; keep keys/card data out of UI/domain; gateways are for **physical/services only** ([payments_overview_and_security.md](payments_overview_and_security.md)).
