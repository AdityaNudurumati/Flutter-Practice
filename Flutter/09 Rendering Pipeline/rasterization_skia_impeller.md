...
- **`rasterDuration`** (frame timings) measures this step; high values = raster-bound jank ([pipeline_overview.md](pipeline_overview.md)).

## Memory Representation

GPU textures/buffers for layers and cached `RepaintBoundary`s live in GPU memory; large/many textures pressure it ([compositing_and_repaint_boundaries.md](compositing_and_repaint_boundaries.md)).
