...
- Store submission steps: [../51%20Deployment/store_setup_and_submission.md](../51%20Deployment/02_store_setup_and_submission.md)
...
- **Observe every release**: wire crash-free rate and key metrics as rollout gates — see [./observability_as_practice.md](./06_observability_as_practice.md).
