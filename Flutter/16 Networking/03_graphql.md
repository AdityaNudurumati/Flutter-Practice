...
- **Operations**:
  ...
  - **Subscription** (real-time): push updates over a WebSocket ([04_websockets_and_realtime.md](04_websockets_and_realtime.md)).
...
The normalized cache holds entities keyed by type+id (in-memory, optionally persisted). Large results still cost memory; request only needed fields ([02 · memory_and_gc](../02%20Advanced%20Dart/13_memory_and_gc.md)).
