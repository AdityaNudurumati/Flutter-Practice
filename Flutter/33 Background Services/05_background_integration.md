...
- **Foreground reconciliation = source of truth**: on app open (and connectivity return — [29 · connectivity](../29%20Device%20Features/04_connectivity.md)), run the same sync; this guarantees correctness regardless of whether background ran. Background merely makes it *timelier*.
