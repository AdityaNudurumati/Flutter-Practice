...
The observer is held by the binding until removed — **remove it in `dispose`** or it leaks (same principle as [05_dispose_and_leaks.md](05_dispose_and_leaks.md)).
...
The embedder reports platform lifecycle events to the engine, surfaced as `AppLifecycleState` ([06 · architecture_overview](../06%20Flutter%20Fundamentals/02_architecture_overview.md)).
