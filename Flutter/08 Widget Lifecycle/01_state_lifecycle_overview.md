...
The `State` lives with its Element (persistent across rebuilds); it holds your controllers/subscriptions until `dispose` ([02 · memory_and_gc](../02%20Advanced%20Dart/13_memory_and_gc.md)).
